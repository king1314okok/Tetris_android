...
import com.sues.wangyi.tetris.R;
import com.sues.wangyi.tetris.TetrisActivityAW;
...
public class TetrisViewAW extends View {
    private RelativeLayout relativeLayout = (RelativeLayout)this.findViewById(R.id.bgLayout);
    private static int bgNum = 0;
    public static int speedUpFlag = 0 ;
    ...
    public int stopGame() {
        // 停止游戏,释放游戏主线程
//        TetrisActivityAW tetrisActivityAW = new TetrisActivityAW();
//        tetrisActivityAW.showMessage();
        ...
        invalidate();
        showToast("游戏结束");
        //Log.d("score",Integer.toString(finalScore));
        return finalScore;
    }
    ...
    private class MainThread implements Runnable {
        ...
        public void run() {
            while (gameStatus) {
                while (runningStatus) {
                    if (speedUpFlag == 1){
                        int speed = GameConfig.SPEED;
                        GameConfig.setSpeed(GameConfig.SPEED/2);
                    }
